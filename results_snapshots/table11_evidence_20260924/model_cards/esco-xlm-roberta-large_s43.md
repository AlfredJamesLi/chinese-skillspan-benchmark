...
language:
  - zh
pretty_name: Table 11 LSKT linear head (esco-xlm-roberta-large, seed 43)
...
Hub: [`AlfredJames/cnss-table11-lskt-esco-xlm-roberta-large-b2-s43`](https://huggingface.co/AlfredJames/cnss-table11-lskt-esco-xlm-roberta-large-b2-s43)
...
Paper cell (three-seed mean ± sample SD, this encoder): **0.538 ± 0.021** typed exact micro-F1 on Gold150. This repository is **seed 43 only**.
...
| File | Role | SHA-256 |
|---|---|---|
| `model.safetensors` | Fine-tuned encoder + 9-label linear head | `2efb6f69def4211a07a9ad30ee4563fe0dd83569d7e3687676b9077be6acc3aa` |
