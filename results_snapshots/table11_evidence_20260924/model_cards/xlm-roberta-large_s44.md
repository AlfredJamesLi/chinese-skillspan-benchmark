...
language:
  - zh
pretty_name: Table 11 LSKT linear head (xlm-roberta-large, seed 44)
...
# Table 11 Chinese LSKT linear head (`xlm-roberta-large`, seed 44)

Hub: [`AlfredJames/cnss-table11-lskt-xlm-roberta-large-b2-s44`](https://huggingface.co/AlfredJames/cnss-table11-lskt-xlm-roberta-large-b2-s44)
...
Paper cell (three-seed mean ± sample SD, this encoder): **0.522 ± 0.022** typed exact micro-F1 on Gold150. This repository is **seed 44 only**.
...
| File | Role | SHA-256 |
|---|---|---|
| `model.safetensors` | Fine-tuned encoder + 9-label linear head | `8946f8cfe5ed772da6d9d97886f2bd1b86be748dc6209d3c9bd1d98d6121b6e3` |
