...
This is **not** JobBERT-zh CRF and **not** the masked-LM checkpoint `FacebookAI/xlm-roberta-large`.
...
`/home/guojingli3/cnss_external_benchmarks_20260921/runs/chinese/full/xlm-roberta-large/44/best`

SHA-256 of `model.safetensors`: `8946f8cfe5ed772da6d9d97886f2bd1b86be748dc6209d3c9bd1d98d6121b6e3`
...
- seed 44, selected epoch 14: **0.544571**
- Gold150 is a 150-sentence human reference freeze (663 spans, L=2), not a new blind test.

## Head vs MLM

`FacebookAI/xlm-roberta-large@c23d21b0620b635a76227c604d44e43a9f0ee389` is fill-mask (`XLMRobertaForMaskedLM` or `RobertaForCustomMaskedLM`).
