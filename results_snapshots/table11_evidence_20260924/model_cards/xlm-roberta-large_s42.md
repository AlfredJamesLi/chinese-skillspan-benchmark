...
language:
  - zh
pretty_name: Table 11 LSKT linear head (xlm-roberta-large, seed 42)
...
# Table 11 Chinese LSKT linear head (`xlm-roberta-large`, seed 42)

Hub: [`AlfredJames/cnss-table11-lskt-xlm-roberta-large-b2-s42`](https://huggingface.co/AlfredJames/cnss-table11-lskt-xlm-roberta-large-b2-s42)
...
Paper cell (three-seed mean ± sample SD, this encoder): **0.522 ± 0.022** typed exact micro-F1 on Gold150. This repository is **seed 42 only**.
...
| File | Role | SHA-256 |
|---|---|---|
| `model.safetensors` | Fine-tuned encoder + 9-label linear head | `c894df3762a57fd8c10af65a2745db33d94f8aa4476fb4077a9615b1de6ef1f5` |
