...
This pack does **not** retrain, does **not** overwrite original run files, and does **not** publish weights.
...
| Hugging Face / Zenodo weight upload | **not done** |
...
5. **Platforms:** lab disk + this pack. GitHub results snapshot already at `46d1166`. Weights are **not** a public model URL. Base-encoder HF pages and JobBERT-zh are **not** these models.
