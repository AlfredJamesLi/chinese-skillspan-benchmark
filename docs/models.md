...
Qwen's pretrained model is `Qwen2.5-14B-Instruct`; project LoRA adapters are not publicly released. See [data access](../DATA_AVAILABILITY.md) and [evaluation instructions](../reproduction/EVALUATION_ENTRY.md).
