...
The Chinese-SkillSpan corpus (22,840 sentences), V4 hybrid evaluation file (2,601 unique IDs), Gold v2 labels, annotation guidelines, predefined splits, and the official scorer `cnss-lskt-1.2.0` are archived at https://doi.org/10.5281/zenodo.22288338 (version v0.1.1; concept DOI https://doi.org/10.5281/zenodo.22288337). Gold150 and the Silver-plus v6a_nocross training lists used for the additional experiments are in the later snapshot https://doi.org/10.5281/zenodo.22698504 (version v0.1.3; GitHub tag `v0.1.3`). Source code is available at https://github.com/AlfredJamesLi/chinese-skillspan-benchmark. The paper-main JobBERT-zh encoder and V4 CRF checkpoint are at https://huggingface.co/AlfredJames/jobbert-zh; the Gold150 v6a B2 continuation is at https://huggingface.co/AlfredJames/jobbert-zh-v6a. Redistribution of original job-advertisement wording remains subject to the source platforms’ terms. Do not write that Gold150 is inside v0.1.1 or v0.1.2.
