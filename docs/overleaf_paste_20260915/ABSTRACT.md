...
**Do not add to Results:** Concept Accuracy, Time-OOD, “label quality far exceeds data size”, P1/kNN F1, peel-rerun F1, SOP-on-Gold150 teacher F1, shared-handbook 0.5403, public-API Silver 7117 / Wave3 / Codex-channel F1, or a single SOTA ranking of 0.5536 vs 0.4331 vs 0.6365 vs 0.5403. P1 / SOP-on-Gold150 / peel go in the appendix only. Shared-handbook 0.5403 belongs in Methods / Reproducibility as a separate protocol, not in Abstract Results.
