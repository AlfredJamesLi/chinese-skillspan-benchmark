...
- Putting Handbook-B gold85 / IAA-50 diagnostics (GPT-6.0 **0.7528**, Kimi IAA-50 **0.6233**, Qwen2.5-14B SOP+jieba **0.2551 / 0.2678**, JobBERT-zh **0.1266 / 0.1522**) into the abstract or as a replacement for V4 hybrid **0.4331**. Gold85 is not blind (GPT-6 overlay visible). Do not rank those F1s against 0.4331 or Gold v2 0.6365. The “need a larger instruction model for human Chinese SkillSpan spans” sentence belongs only in `reports/human_gold85_iaa50/README.md` / the confirmed-results diagnostic section.
